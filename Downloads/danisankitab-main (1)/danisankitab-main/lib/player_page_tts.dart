...
class _PlayerPageTtsState extends State<PlayerPageTts>
  ...
  void initState() {
    ...
    final player = ConcatenatingAudioSource(children: [
      ...
      AudioSource.uri(Uri.parse(
          'https://danisankitab.az/persistent/' + widget.bookNode.mp3Uri))
    ]);
              ...
              children: [
                ...
                Material(
                    ...
                    child: Center(
                      ...
                      children: [
                        AnimatedPadding(
                          padding: EdgeInsets.all(_player.playing ? 30 : 50),
                            ...
                            return Column(
                              children: [
                                Slider(
                                  ...
                                  max: widget.bookNode.duration.inSeconds
                                      .toDouble(),
                                ...
                                Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(myFormatDuration(d),
                                            style:
                                                TextStyle(color: Colors.white)),
                                        Text(
                                            myFormatDuration(
                                                widget.bookNode.duration),
                                            style:
                                                TextStyle(color: Colors.white))
                                      ],
                                    )),
                        ...
                        Row(
                          ...
                          children: [
                            IconButton(
                              icon:
                                  Icon(cupertino.CupertinoIcons.backward_fill),
                              color: Colors.white,
                              iconSize: 50,
                              onPressed: () {},
                            ),
